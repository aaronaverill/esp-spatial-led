	...
	<div class="d-flex flex-column h-100" class="h-100">
		<div class="main">
			...
			<div id="p1.1" class="d-none flex-column h-100">
				<div class="title">
          <div onclick="showPage('1')" class="btn pa-4"><div class="img img-close"></div></div>
          <div class="pa-3">Options</div>
			...
			<div id="p2.1" class="d-none flex-column h-100">
				<div class="title">
					<div onclick="showPage('2')" class="btn pa-4"><div class="img img-close"></div></div>
...
const char app_js[] PROGMEM = R"rawstring(
let globalFields = [
  {
    id: 'brightness',
    type: 'slider',
